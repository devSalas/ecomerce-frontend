    ...
    <>
      <button className="relative w-10 h-10" onClick={handleClick}>
        <svg
          ...
          viewBox="0 0 294.038 294.038"
          enable-background="new 0 0 294.038 294.038"
          fill="#999"
        >
          <g>
        ...
        {store.products.length === 0 ? null : (
          <span className="bg-red-500 w-6 h-6 absolute bottom-0 right-0 rounded-full text-white">
            {store.products.length}
          </span>
        )}
      </button>
      <CarritoModal click={handleClick} active={active} />
    </>
  );
}
